...
final class Elev8_OS_Mobile_Home_Module {
    ...
    private static function cards_for_user(WP_User $user): array {
        ...
        if (class_exists('Elev8_OS_Access_Service') && Elev8_OS_Access_Service::can_distribute_flyers($user)) {
            $cards[] = self::card(__('Community Outreach', 'elev8-os'), __('View flyer campaigns, visit locations, and record completed deliveries.', 'elev8-os'), admin_url('admin.php?page=elev8-community-outreach'), 'location-alt');
        }
