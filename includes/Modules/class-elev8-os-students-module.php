...
final class Elev8_OS_Students_Module {
                        ...
                        <?php else:?><div class="elev8-student-card-grid">
                            <?php foreach($students as $student): $url=add_query_arg(['student'=>(string)$student['customer_key'],'segment'=>$segment,'q'=>$query],Elev8_OS_Portal_Page_Manager::get_url('students')); ?>
                                <article class="elev8-student-card<?php echo $selected_key===$student['customer_key']?' is-selected':''; ?>">
                                    <?php if($selected_key===$student['customer_key']): ?><span class="elev8-selected-badge"><?php esc_html_e('Selected','elev8-os'); ?></span><?php endif; ?>
    ...
    private static function render_detail(array $student,string $segment,string $query): void { $return=add_query_arg(array_filter(['student'=>(string)$student['customer_key'],'segment'=>$segment,'q'=>$query]),Elev8_OS_Portal_Page_Manager::get_url('students')); ?>
        <aside class="elev8-student-detail">
            <div class="elev8-detail-heading"><div class="elev8-student-avatar large"><?php echo esc_html(self::initials((string)$student['name'])); ?></div><div><p class="elev8-eyebrow"><?php esc_html_e('Customer Profile','elev8-os'); ?></p><h2><?php echo esc_html((string)$student['name']); ?></h2><p><?php echo esc_html(sprintf(__('Customer since %s','elev8-os'),self::date((string)$student['first_class_at']))); ?></p></div></div>
            <div class="elev8-contact-actions"><?php if($student['email']!==''):?><a class="button elev8-action-primary" href="mailto:<?php echo esc_attr((string)$student['email']); ?>"><span class="dashicons dashicons-email-alt" aria-hidden="true"></span><?php esc_html_e('Send Email','elev8-os'); ?></a><?php endif; ?><?php if($student['phone']!==''):?><a class="button elev8-action-secondary" href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/','',(string)$student['phone'])); ?>"><span class="dashicons dashicons-phone" aria-hidden="true"></span><?php esc_html_e('Call','elev8-os'); ?></a><?php endif; ?><a class="button elev8-action-secondary" href="#elev8-private-notes"><span class="dashicons dashicons-edit" aria-hidden="true"></span><?php esc_html_e('Add Note','elev8-os'); ?></a></div>
