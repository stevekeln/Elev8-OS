                ...
                <section class="elev8-dashboard-panel elev8-next-class-panel">
                    ...
                    <?php else : ?>
                        ...
                        <article class="elev8-next-class">
                            <div class="elev8-next-class-date"><small><?php echo esc_html($ts ? wp_date('D', $ts) : ''); ?></small><span><?php echo esc_html($ts ? wp_date('M', $ts) : ''); ?></span><strong><?php echo esc_html($ts ? wp_date('j', $ts) : ''); ?></strong></div>
                            <div class="elev8-next-class-body"><h3><?php echo esc_html((string) $next_class['name']); ?></h3><p><span class="dashicons dashicons-clock"></span><?php echo esc_html(class_exists('Elev8_OS_My_Classes_Module') ? Elev8_OS_My_Classes_Module::format_schedule_date((string) $next_class['start'], !empty($next_class['date_only']), false) : ($ts ? wp_date('l, F j, Y · ' . get_option('time_format'), $ts) : (string) $next_class['start'])); ?></p><?php if ((string)$next_class['location'] !== '') : ?><p><span class="dashicons dashicons-location"></span><?php echo esc_html((string)$next_class['location']); ?></p><?php endif; ?><div class="elev8-next-class-facts"><span><strong><?php echo esc_html(number_format_i18n((int)$next_class['students'])); ?></strong> <?php esc_html_e('students', 'elev8-os'); ?></span><span><strong><?php echo $next_class['seats_left'] === null ? esc_html__('Unavailable','elev8-os') : esc_html(number_format_i18n((int)$next_class['seats_left'])); ?></strong> <?php esc_html_e('seats left', 'elev8-os'); ?></span></div></div>
                        </article>
                    <?php endif; ?>
                </section>
