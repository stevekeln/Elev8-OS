...
final class Elev8_OS {
    ...
    public static function save_artist_profile(): void {
        ...
        $profiles[$employee_id] = [
            ...
            'gallery' => isset($_POST['gallery']) ? sanitize_textarea_field(wp_unslash($_POST['gallery'])) : '',
    ...
    private static function public_profile_content(int $employee_id): string {
        ...
        <div class="elev8-os elev8-public-profile">
          ...
          <?php if($gallery):?><div class="elev8-panel"><h2>Artwork gallery</h2><div class="elev8-gallery"><?php foreach($gallery as $img):?><img src="<?php echo esc_url($img);?>" alt="Artwork by <?php echo esc_attr($name);?>"><?php endforeach;?></div></div><?php endif;?>
