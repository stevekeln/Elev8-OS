...
final class Elev8_OS_Business_Intelligence {
    ...
    public static function get_dashboard_report(): array {
        ...
        $booked_value = self::booked_value($schema, $month_start, $next_month_start);
        ...
        return [
            ...
            'metrics'      => [
                ...
                'recognized_revenue' => self::unavailable_metric(
                    __('Recognized revenue requires a dedicated revenue-recognition policy and is intentionally not calculated in Business Intelligence v1.', 'elev8-os')
                ),
            ],
    ...
    private static function booked_value(array &$schema, string $start, string $end): array {
        ...
        return [
            ...
            'format' => 'currency',
            'confidence' => 'medium',
            'diagnostic' => __('Booked value is based on detected booking amounts. It is not recognized revenue and does not account for payment settlement, refunds, fees, or payout rules.', 'elev8-os'),
        ];
    }
