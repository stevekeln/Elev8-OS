...
final class Elev8_OS_Application_Shell_Module {
    ...
    private static function should_render_frontend(): bool {
        ...
        $known = ['checkin', 'elev8-mobile-home', 'artist-dashboard', 'elev8-conversations', 'elev8-workspace', 'glass-manager', 'glass-workbench', 'elev8-order-capture'];
        ...
        <div class="elev8-app-shell" data-elev8-app-shell data-elev8-shell-context="<?php echo esc_attr($context); ?>">
            <div class="elev8-app-shell__inner">
                ...
                <nav class="elev8-app-shell__nav" aria-label="<?php esc_attr_e('Elev8 OS navigation', 'elev8-os'); ?>">
                    ...
                    <?php if (class_exists('Elev8_OS_Operational_Readiness_Service') && Elev8_OS_Operational_Readiness_Service::can_manage($user)): ?><a href="<?php echo esc_url($readiness_url); ?>"><?php esc_html_e('Readiness', 'elev8-os'); ?></a><?php endif; ?>
            ...
            <div class="elev8-app-shell__menu" id="elev8-app-user-menu" hidden>
                ...
                <?php if (class_exists('Elev8_OS_Operational_Readiness_Service') && Elev8_OS_Operational_Readiness_Service::can_manage($user)): ?><a href="<?php echo esc_url($readiness_url); ?>">✅ <span><?php esc_html_e('Operational Readiness', 'elev8-os'); ?></span></a><?php endif; ?>
