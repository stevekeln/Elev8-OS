...
final class Elev8_OS_My_Artwork_Module {
    ...
    private static function render_asset_card(array $asset): void {
        ...
        $qr_target = $product_url !== '' ? $product_url : Elev8_OS_Portal_Page_Manager::get_url('artwork');
